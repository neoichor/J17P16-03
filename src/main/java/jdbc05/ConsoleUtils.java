...
public class ConsoleUtils {
    ...
    public static void printItemList(List<ItemDTO> items) {
        System.out.println("【現在登録されている品目】");
    ...
    public static void printCashbookList(List<CashbookDTO> cashbooks) {
        ...
        System.out.println("----------------------------------------------------------------------------------------");
        System.out.printf("%-4s | %-10s | %-12s | %-20s | %10s | %10s%n", "ID", "日付", "費目名", "メモ", "入金額", "出金額");
        System.out.println("----------------------------------------------------------------------------------------");
     ...
     */
    public static void printCashbookDetails(CashbookDTO cashbook, String itemName) {
        if (cashbook == null) {
            return;
        }

        System.out.println("【操作対象データ】");
        System.out.println("--------------------");
